...
const ENGINE_ADDITIONS = {
  Narrative: "Focus on brand story, voice, positioning.",
  Content:   "Focus on content strategy, hooks, formats, posting systems.",
  Growth:    "Focus on growth hacking, acquisition, ROAS, LTV.",
  Trend:     "Focus on real-time viral trends, cultural moments.",
...
export default function CreatorDashboard({ onUpgrade, onLogout }) {
              ...
              {isEmpty && (
                ...
                >
                  ...
                  <h1 className="font-extrabold mb-3" style={{ fontFamily:"Sora,sans-serif", fontSize:"clamp(32px,5vw,48px)", color:"#f0faf2", lineHeight:1.15 }}>
                    What will you{" "}
                    <span className="gradient-text-green">create today?</span>
                  </h1>
