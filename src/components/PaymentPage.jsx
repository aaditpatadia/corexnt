...
function CheckIcon() {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#2dd668" strokeWidth="2.5" strokeLinecap="round">
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow:  plan.popular
            ? "0 0 40px rgba(45,214,104,0.1), 0 8px 32px rgba(0,0,0,0.4)"
            : "0 4px 24px rgba(0,0,0,0.3)",
          transition:"all 0.3s ease",
        }}>
        {plan.popular && (
          <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full text-xs font-bold"
            style={{ background:"#2dd668", color:"#050a06", fontFamily:"var(--font-body)" }}>
            Most Popular
          </div>
        )}

        <div className="mb-5">
          <h3 className="text-xl font-bold mb-1" style={{ fontFamily:"var(--font-body)", color:"#f0faf2" }}>
            {plan.name}
          </h3>
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-3xl font-extrabold"
              style={{ fontFamily:"var(--font-body)", color: plan.popular ? "#2dd668" : "#f0faf2" }}>
              {plan.price}
            </span>
            {plan.period && (
        ...
        <motion.button
          ...
          style={plan.popular
            ? { background:"#2dd668", color:"#050a06", fontFamily:"var(--font-body)" }
            : { background:"rgba(45,214,104,0.07)", border:"1px solid rgba(45,214,104,0.18)", color:"#f0faf2", fontFamily:"var(--font-body)" }
          }>
          {plan.cta}
        </motion.button>
      </motion.div>
    ...
    <div className="h-full overflow-y-auto scroll-area relative z-10 px-4 py-10">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold mb-3" style={{ fontFamily:"var(--font-body)", color:"#f0faf2" }}>
            Choose your{" "}
        ...
        <p className="text-center text-xs mt-12" style={{ color:"var(--text-muted)", fontFamily:"var(--font-body)" }}>
